...
Твоя задача — преобразовывать текстовый запрос пользователя в JSON-словарь с IATA-кодами городов, диапазоном дат вылета, валютой и бюджетом.
...
{{"departure": "MOW", "destination": "AYT", "range_from": "2024-10-07", "range_to": "2024-10-23", "currency": "RUB", "max_price": 15000}}
...
"""
    ...
    try:
        ...
        # Опциональные поля: currency, max_price
